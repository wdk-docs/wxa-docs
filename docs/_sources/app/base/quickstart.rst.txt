...
.. figure:: /assets/images/register.png
   :alt: 注册
...
登录 https://mp.weixin.qq.com ，我们可以在菜单 “设置”-“开发设置”
看到小程序的 AppID 了 。

.. figure:: /assets/images/setting.png
   :alt: 登录
...
新建项目选择小程序项目，选择代码存放的硬盘路径，填入刚刚申请到的小程序的
AppID，给你的项目起一个好听的名字，最后，勾选 “创建 QuickStart 项目”
(注意:
你要选择一个空的目录才会有这个选项)，点击确定，你就得到了你的第一个小程序了，点击顶部菜单编译就可以在
IDE 预览你的第一个小程序。

.. figure:: /assets/images/first-program.png
   :alt: 你的第一个小程序
